    ...
    <div class="container" id="content-filter">
        ...
        <div class="row row-cols-1 row-cols-md-3">
            ...
            if (isset($_GET['bcari'])) {
                ...
                $q = "SELECT * FROM games WHERE title LIKE '%$keyword%'";
                ...
                if ($hasil) {
                    ...
                    while ($row = mysqli_fetch_object($hasil)) {
                        // Tampilkan data
                        echo '<a href="katalog.php?id=' . $row->id . '" style="text-decoration: none;">';
                        echo '<div class="col py-4" data-aos="zoom-in" data-aos-duration="1000">';
                        echo '<div class="card border-dark h-100" style="border-color: white;">';
                        echo '<img src="' . $row->photo . '" class="card-img-top" alt="valorant">';
